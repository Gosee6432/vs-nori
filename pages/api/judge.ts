...
2. 아래 항목을 포함하세요:
- 개요: 간단한 비교 대상 소개  
- 근거: 사실에 기반한 정보, 두 항목 각각의 특징, 업적, 객관적 수치(가능한 경우 웹 검색을 통해 – 조회수, 연도, 수상, 판매량, 팔로워 등)를 기반으로 설명, 검색 사실이 아닌 내용은 명시하지 말 것, 가급적 최근 자료를 사용할 것, 비교대상을 객관적으로 판단할 수 있는 다섯 개 기준을 설정하고, 그 기준에 맞춰 분석
